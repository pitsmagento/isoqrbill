...
class SvgWriter extends AbstractWriter
{
    ...
    private function addLogo(SimpleXMLElement $svg, int $imageWidth, int $imageHeight, string $logoPath, mixed $logoWidth = null, mixed $logoHeight = null, bool $forceXlinkHref = false): void
    {
