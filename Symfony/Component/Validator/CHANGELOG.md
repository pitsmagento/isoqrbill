 ...
 * removed `Pits\PitsQrCode\Symfony\Component\Validator\Mapping\Cache\CacheInterface` in favor of PSR-6.
 ...
 * deprecated `Pits\PitsQrCode\Symfony\Component\Validator\Mapping\Cache\CacheInterface` in favor of PSR-6.
 ...
 * decoupled from `symfony/translation` by using `Pits\PitsQrCode\Symfony\Contracts\Translation\TranslatorInterface`
 ...
 * deprecated `DefaultTranslator` in favor of `Pits\PitsQrCode\Symfony\Component\Translation\IdentityTranslator`
 ...
 * copied the constraints `Optional` and `Required` to the
   `Pits\PitsQrCode\Symfony\Component\Validator\Constraints\` namespace and deprecated the original
   classes.
