...
namespace Pits\PitsQrCode\Symfony\Component\Validator\Mapping;

use Pits\PitsQrCode\Symfony\Component\Validator\Constraint;
use Pits\PitsQrCode\Symfony\Component\Validator\Constraints\Cascade;
use Pits\PitsQrCode\Symfony\Component\Validator\Constraints\DisableAutoMapping;
use Pits\PitsQrCode\Symfony\Component\Validator\Constraints\EnableAutoMapping;
use Pits\PitsQrCode\Symfony\Component\Validator\Constraints\Traverse;
...
class GenericMetadata implements MetadataInterface
{
    ...
    public function addConstraint(Constraint $constraint)
    {
        if ($constraint instanceof Traverse || $constraint instanceof Cascade) {
            throw new ConstraintDefinitionException(sprintf('The constraint "%s" can only be put on classes. Please use "Pits\PitsQrCode\Symfony\Component\Validator\Constraints\Valid" instead.', get_debug_type($constraint)));
        }
