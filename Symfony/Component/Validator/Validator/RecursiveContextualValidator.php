...
namespace Pits\PitsQrCode\Symfony\Component\Validator\Validator;

use Pits\PitsQrCode\Symfony\Component\Validator\Constraint;
use Pits\PitsQrCode\Symfony\Component\Validator\Constraints\Composite;
use Pits\PitsQrCode\Symfony\Component\Validator\Constraints\Existence;
use Pits\PitsQrCode\Symfony\Component\Validator\Constraints\GroupSequence;
use Pits\PitsQrCode\Symfony\Component\Validator\Constraints\Valid;
use Pits\PitsQrCode\Symfony\Component\Validator\ConstraintValidatorFactoryInterface;
use Pits\PitsQrCode\Symfony\Component\Validator\Context\ExecutionContext;
use Pits\PitsQrCode\Symfony\Component\Validator\Context\ExecutionContextInterface;
use Pits\PitsQrCode\Symfony\Component\Validator\Exception\ConstraintDefinitionException;
use Pits\PitsQrCode\Symfony\Component\Validator\Exception\NoSuchMetadataException;
use Pits\PitsQrCode\Symfony\Component\Validator\Exception\RuntimeException;
use Pits\PitsQrCode\Symfony\Component\Validator\Exception\UnexpectedValueException;
use Pits\PitsQrCode\Symfony\Component\Validator\Exception\UnsupportedMetadataException;
use Pits\PitsQrCode\Symfony\Component\Validator\Exception\ValidatorException;
use Pits\PitsQrCode\Symfony\Component\Validator\Mapping\CascadingStrategy;
use Pits\PitsQrCode\Symfony\Component\Validator\Mapping\ClassMetadataInterface;
use Pits\PitsQrCode\Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface;
use Pits\PitsQrCode\Symfony\Component\Validator\Mapping\GenericMetadata;
use Pits\PitsQrCode\Symfony\Component\Validator\Mapping\GetterMetadata;
use Pits\PitsQrCode\Symfony\Component\Validator\Mapping\MetadataInterface;
use Pits\PitsQrCode\Symfony\Component\Validator\Mapping\PropertyMetadataInterface;
use Pits\PitsQrCode\Symfony\Component\Validator\Mapping\TraversalStrategy;
use Pits\PitsQrCode\Symfony\Component\Validator\ObjectInitializerInterface;
use Pits\PitsQrCode\Symfony\Component\Validator\Util\PropertyPath;
...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
    ...
    public function validateProperty($object, string $propertyName, $groups = null)
    {
        ...
        if (!$classMetadata instanceof ClassMetadataInterface) {
            throw new ValidatorException(sprintf('The metadata factory should return instances of "\Pits\PitsQrCode\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
        }
    ...
    private function validateObject($object, string $propertyPath, array $groups, int $traversalStrategy, ExecutionContextInterface $context)
    {
        try {
            ...
            if (!$classMetadata instanceof ClassMetadataInterface) {
                throw new UnsupportedMetadataException(sprintf('The metadata factory should return instances of "Pits\PitsQrCode\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
            }
        ...
        foreach ($groups as $key => $group) {
            ...
            if (Constraint::DEFAULT_GROUP === $group) {
                if ($metadata->hasGroupSequence()) {
                    ...
                    // object
                    /* @var \Pits\PitsQrCode\Symfony\Component\Validator\GroupSequenceProviderInterface $object */
        ...
        foreach ($metadata->getConstrainedProperties() as $propertyName) {
            ...
            foreach ($metadata->getPropertyMetadata($propertyName) as $propertyMetadata) {
                if (!$propertyMetadata instanceof PropertyMetadataInterface) {
                    throw new UnsupportedMetadataException(sprintf('The property metadata instances should implement "Pits\PitsQrCode\Symfony\Component\Validator\Mapping\PropertyMetadataInterface", got: "%s".', get_debug_type($propertyMetadata)));
                }
