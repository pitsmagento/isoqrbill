...
use Pits\PitsQrCode\Symfony\Component\Intl\Exception\RuntimeException;
...
final class Timezones extends ResourceBundle
{
     ...
     */
    public static function getName(string $timezone, mixed $displayLocale = null): string
    {
     ...
     * @return string[]
     */
    public static function getNames(mixed $displayLocale = null): array
    {
     ...
     */
    public static function getRawOffset(string $timezone, mixed $timestamp = null): int
    {
        if (null === $timestamp) {
            $timestamp = time();
        }
    ...
    public static function getGmtOffset(string $timezone, mixed $timestamp = null, mixed $displayLocale = null): string
    {
