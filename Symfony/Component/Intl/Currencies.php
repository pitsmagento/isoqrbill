...
final class Currencies extends ResourceBundle
{
     ...
     */
    public static function getName(string $currency, mixed $displayLocale = null): string
    {
     ...
     * @throws MissingResourceException if the currency code does not exist
     */
    public static function getSymbol(string $currency, mixed $displayLocale = null): string
    {
