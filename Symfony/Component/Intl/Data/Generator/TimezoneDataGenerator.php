...
namespace Pits\PitsQrCode\Symfony\Component\Intl\Data\Generator;

use Pits\PitsQrCode\Symfony\Component\Filesystem\Filesystem;
use Pits\PitsQrCode\Symfony\Component\Intl\Data\Bundle\Compiler\BundleCompilerInterface;
use Pits\PitsQrCode\Symfony\Component\Intl\Data\Bundle\Reader\BundleEntryReaderInterface;
use Pits\PitsQrCode\Symfony\Component\Intl\Data\Util\ArrayAccessibleResourceBundle;
use Pits\PitsQrCode\Symfony\Component\Intl\Data\Util\LocaleScanner;
use Pits\PitsQrCode\Symfony\Component\Intl\Exception\MissingResourceException;
...
class TimezoneDataGenerator extends AbstractDataGenerator
{
    ...
    private function generateZones(BundleEntryReaderInterface $reader, string $tempDir, string $locale): array
    {
        ...
        $resolveName = function (string $id, mixed $city = null) use ($reader, $tempDir, $locale, $regionFormat, $fallbackFormat): ?string {
