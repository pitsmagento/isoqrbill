...
namespace Pits\PitsQrCode\BaconQrCode\Renderer\Image;

use Pits\PitsQrCode\BaconQrCode\Exception\RuntimeException;
use Pits\PitsQrCode\BaconQrCode\Renderer\Color\Alpha;
use Pits\PitsQrCode\BaconQrCode\Renderer\Color\Cmyk;
use Pits\PitsQrCode\BaconQrCode\Renderer\Color\ColorInterface;
use Pits\PitsQrCode\BaconQrCode\Renderer\Color\Gray;
use Pits\PitsQrCode\BaconQrCode\Renderer\Color\Rgb;
use Pits\PitsQrCode\BaconQrCode\Renderer\Path\Close;
use Pits\PitsQrCode\BaconQrCode\Renderer\Path\Curve;
use Pits\PitsQrCode\BaconQrCode\Renderer\Path\EllipticArc;
use Pits\PitsQrCode\BaconQrCode\Renderer\Path\Line;
use Pits\PitsQrCode\BaconQrCode\Renderer\Path\Move;
use Pits\PitsQrCode\BaconQrCode\Renderer\Path\Path;
use Pits\PitsQrCode\BaconQrCode\Renderer\RendererStyle\Gradient;
use Pits\PitsQrCode\BaconQrCode\Renderer\RendererStyle\GradientType;
...
final class EpsImageBackEnd implements ImageBackEndInterface
{
    ...
    public function new(int $size, ColorInterface $backgroundColor) : void
    {
        $this->eps = "%!PS-Adobe-3.0 EPSF-3.0\n"
            . "%%Creator: Pits\PitsQrCode\BaconQrCode\n"
