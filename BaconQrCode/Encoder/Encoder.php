...
namespace Pits\PitsQrCode\BaconQrCode\Encoder;

use Pits\PitsQrCode\BaconQrCode\Common\BitArray;
use Pits\PitsQrCode\BaconQrCode\Common\CharacterSetEci;
use Pits\PitsQrCode\BaconQrCode\Common\ErrorCorrectionLevel;
use Pits\PitsQrCode\BaconQrCode\Common\Mode;
use Pits\PitsQrCode\BaconQrCode\Common\ReedSolomonCodec;
use Pits\PitsQrCode\BaconQrCode\Common\Version;
use Pits\PitsQrCode\BaconQrCode\Exception\WriterException;
use SplFixedArray;
...
final class Encoder
{
     ...
     */
    private static function chooseMode(string $content, mixed $encoding = null) : Mode
    {
